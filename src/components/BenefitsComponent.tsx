...
const BenefitsComponent: FC = () => {
  ...
  const benefits = [
    ...
    "Регулярные соревнования и праздники с подарками",
  ];
    ...
    <section className="bg-gradient-to-b from-blue-50 to-blue-100 relative overflow-hidden py-20">
      ...
      <div className=" container  mx-auto py-16 relative z-10">
        ...
        <motion.p
          ...
          variants={textVariants}
        >
          Мы обучаем плаванию детей от 3 месяцев до 10 лет по современной
          методике, превращая каждый урок в увлекательное приключение. Наши
          просторные бассейны оснащены системами глубокой очистки и поддержания
