      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.h1
            ...
            variants={fadeInUp}
          >
            Соляная пещера в СПб - оздоровительные сеансы
          </motion.h1>
          ...
          >
            ...
            релаксации в современной соляной пещере
          </motion.p>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              >
                <video
                  ...
                  loop
                  playsInline
                  aria-label="Видео соляной пещеры"
                >
                  <source src={Video} type="video/mp4" />
                  Ваш браузер не поддерживает видео тег.
                </video>
                <figcaption className="sr-only">
                  Видео соляной пещеры
                </figcaption>
              </motion.figure>
        ...
        >
          ...
          >
            <motion.h2
              ...
              variants={fadeInUp}
            >
              Как проходят сеансы в соляной пещере
            </motion.h2>
          ...
          <motion.div className="space-y-6" variants={staggerContainer}>
            ...
            >
              <img
                src={photo2}
                alt="Комфортная атмосфера для отдыха в соляной пещере"
                className="w-full h-full object-cover"
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <figcaption className="text-white text-xl font-bold">
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl">
              {pricingPlans.map((plan, index) => (
                <motion.article
                  key={index}
                  className={`bg-white rounded-2xl p-6 border overflow-hidden relative flex flex-col h-full ${
                    plan.popular
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {galleryImages.map((image, index) => (
              ...
              >
                <img
                  src={image}
                  alt={`Интерьер соляной пещеры ${index + 1}`}
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
