...
import photo6 from "@/static/kybok_ytenka2.jpg";
              ...
              <div>
                ...
                <ul className="mb-6 space-y-3 text-gray-700">
                  {[
                    ...
                    "Иметь действующую медицинскую справку(от педиатора + энтеробиоз)",
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mb-6 text-gray-700">
                Воспитанники плавательного центра "Утенок", после обучения
                плаванию, регулярно зачисляются в спортивные школы для
