  ...
  const promotions = [
    {
      ...
      description:
        "Попробуйте наш центр плавания абсолютно бесплатно! Первое ознакомительное занятие в любой группе без оплаты.",
      conditions: "Для новых клиентов. Требуется предварительная запись.",
    },
    {
      ...
      discount: "20% скидка",
      validUntil: "Бессрочно",
      duration: "От 8 занятий",
      description:
        "Приходите плавать всей семьей и получайте скидку на каждого последующего члена семьи.",
      conditions:
        "При покупке абонемента от 8 занятий. Требуется подтверждение родства.",
    },
    {
      title: "Утренние часы",
      type: "",
      ...
      description:
        "��анимайтесь плаванием в утренние часы и получайте скидку на все виды абонементов.",
      conditions: "Действует на занятия, начинающиеся до 12:00 в будние дни.",
    },
    {
      ...
      duration: "12 месяцев",
      description:
        "Приобретите годовой абонемент на занятия и получите максимальную выгоду.",
      conditions:
        "Абонемент действует 12 месяцев с момента покупки. Возможна заморозка до 30 дней.",
    },
    {
      title: "Приведи друга",
      type: "",
    ...
    },
    {
      ...
      duration: "10 занятий",
      description:
        "Интенсивный курс обучения плаванию за 10 занятий с индивидуальным подходом.",
      conditions:
        "Занятия должны быть использованы в течение 30 дней с момента первого посещения.",
    },
  ];
